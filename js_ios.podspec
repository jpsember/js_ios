...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of js_ios in Markdown format.
  ...
  s.homepage     = "https://github.com/jpsember"
  ...
  #
  s.source       = { :git => "https://jpsember@bitbucket.org/jpsember/js_ios.git", :commit => "7b6f56c" }
  ...
  s.source_files  = "js_ios/*.{h}"    # Will it omit .m files as expected?
